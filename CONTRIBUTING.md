...
The README template contains specific tracking image as a final entry in the page with img tag by default to https://pnptelemetry.azurewebsites.net/pnp-officeaddins/samples/name-of-sample. This is transparent image, which is used to track anonymous view counts of individual samples in GitHub. Update the image `src` attribute according to correct repository name and folder information. For example, if your sample is **/prompts** folder and named as "my-ai-tool", the `src` attribute should be updated as https://pnptelemetry.azurewebsites.net/pnp-officeaddins/prompts/my-ai-tool.
...
1. Fork this repository [OfficeDev/Office-Developer-AI-Tools](https://github.com/OfficeDev/Office-Developer-AI-Tools) to your GitHub account.
...
* Search [GitHub](https://github.com/OfficeDev/Office-Develoepr-AI-Tools/pulls) for an open or closed Pull Request
  that relates to your submission. You don't want to duplicate effort.

* Make sure you have a link in your local cloned fork to the [OfficeDev/Office-Developer-AI-Tools](https://github.com/OfficeDev/Office-Developer-AI-Tools) repository.

  ```shell
  # check if you have a remote pointing to the Microsoft repository
  git remote -v

  # if you see a pair of remotes (fetch & pull) that point to https://github.com/OfficeDev/Office-Developer-AI-Tools, you're ok... otherwise you need to add one

  # add a new remote named "upstream" and point to the Microsoft repository
  git remote add upstream https://github.com/OfficeDev/Office-Developer-AI-Tools.git
  ```
...
* Ensure your fork is updated and not behind the upstream **Office-Developer-AI-Tools** repository. Refer to these resources for more information on syncing your repository:
  ...
  * For a quick cheat sheet:
    ...
    # assuming you have a remote named `upstream` pointing to the official Office-Developer-AI-Tools repository
    git fetch upstream
...
1. Fork the **Office-Developer-AI-Tools** repository from GitHub.

1. Create a local git repository.

    ```shell
    md Office-Developer-AI-Tools
    cd Office-Developer-AI-Tools
    git init
    ```

1. Pull your forked copy of **Office-Developer-AI-Tools** into your local repository.

    ```shell
    git remote add origin https://github.com/yourgitaccount/Office-Developer-AI-Tools.git
    git pull origin main
    ```

1. Pull your other project from Github into the samples folder of your local copy of the Office-Developer-AI-Tools repository.
